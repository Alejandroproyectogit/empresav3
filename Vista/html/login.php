        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="#" class="nav-item nav-link">Ibagué</a>
                    </div>
                </div>
                ...
                <div class="container py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <form action="index.php?accion=verificar" method="post">
                                <h1 class="text-primary m-3 text-center">Iniciar Sesión</h3>
                                <div class="mb-3">
                            ...
                            <a href="index.php?accion=recordar">¿Olvidó sus credenciales?</a>
                            </div>
