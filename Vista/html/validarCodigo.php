                ...
                <div class="container py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <form action="index.php?accion=validarCodigo" method="post">
                                <h1 class="text-primary m-3 text-center">Ingresa el Código de Verificación</h1>
                                <div class="mb-3">
                                <div class="d-flex">
                                    <input type="text"  name="entrada1" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada2" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada3" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada4" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada5" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada6" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada7" class="form-control text-center form-cuadros" maxlength="1" required>
                                    <input type="text"  name="entrada8" class="form-control text-center form-cuadros" maxlength="1" required>
                                </div>
                                </div>
