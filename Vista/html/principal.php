                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="index.php?accion=paginaProveedor" class="dropdown-item">PROVEEDOR</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">PINCHOS<br>EL SABOR TOLIMENSE</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">SEGUIMIENTO DE INVENTARIO</p>
                        </div>
