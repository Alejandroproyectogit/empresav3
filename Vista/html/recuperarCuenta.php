                ...
                <div class="container py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <form action="index.php?accion=recuperar" method="post">
                                <h1 class="text-primary m-3 text-center">Recuperar Contraseña</h3>
                                <div class="mb-3">
                        ...
                        if(isset($_SESSION['exito'])){
                            echo "<p id='error'>".$_SESSION['exito']."</p>";
                            echo "<div class='text-center'>
                            <a href='index.php?accion=paginaValidar' class='navbar-brand text-center'>Ir a ingresar codigo de restablecimiento de contraseña</a>
                            </div>";
